...
In case of multiple values that minimize $U_h$, it is assumed that $f_h$ returns the lowest such value, this is consistent with the PoA being a theoretical upper bound of the effect of uncoordinated behaviour.
