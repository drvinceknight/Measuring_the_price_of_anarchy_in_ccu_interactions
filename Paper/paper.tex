...
Figure \ref{Fig:target_demand_model1} shows the effect of $t$ and overall demand (note: the non linear scale).
...
A result is proved that allows for the assertion of existence of Nash equilibrium. This result is then applied to two particular models that are influenced by discussions with a local health board:
